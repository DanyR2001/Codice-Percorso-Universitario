...
@NamedQueries({
        ...
        @NamedQuery(name=Casa.SELECT_BY_TYPE,query="Select c from Casa c where c.tipo=:tipo"),
...
public class Casa implements Serializable {
    ...
    @Id
    private int id;
    private String tipo,indirizzo,CAP,stato;    //variabile stato nel compito è stata definita come "locabile" per confusione

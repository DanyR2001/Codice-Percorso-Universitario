...
@NamedQueries({
    ...
    @NamedQuery(name=CanzoneSanremo.SELECTBYCATEGORY,query="select c from CanzoneSanremo c where c.categoria=?1"),
    @NamedQuery(name=CanzoneSanremo.SELECTBYID,query="select c from CanzoneSanremo c where c.id=:id ")
})
public class CanzoneSanremo implements Serializable {
    ...
    public String toString() {
        return "standardPackage.CanzoneSanremo[ id=" + id + " ]";
    }
